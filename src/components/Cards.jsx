...
const Cards = () => {
  ...
  const handleBasicPlan = () => {
    ReactGA.event({
      category: "Price",
      action: "Price button clicked",
      label: "Price-Basic",
    });
    alert("For more infomration about our basic plan please use our contact form");
  };

  const handlePackagePlan = () => {
    ReactGA.event({
      category: "Price",
      action: "Price button clicked",
      label: "Price-Package",
    });
    alert("For more infomration about our package plan please use our contact form");
  };
  ...
  const handleEnterprisePlan = () => {
    ReactGA.event({
      category: "Price",
      action: "Price button clicked",
      label: "Price-Enterprise",
    });
    alert("For more infomration about our enterprise plan please use our contact form");
  };
  ...
  return (
    <div className="w-full py-[10rem] px-4 bg-white">
      ...
      <h1
        className="text-4xl font-bold text-center mb-16 text-gray-600"
        id="price"
      >
        Current Plans
      </h1>
      ...
      <div className=" max-w-[1240px] mx-auto grid lg:grid-cols-3 gap-8">
        <div className=" w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 hover:bg-gray-100 pt-20 mb-20">
          ...
          >
            <button
              className="text-[#81cdba] font-semibold"
        ...
        <div className="w-full shadow-xl bg-white flex flex-col p-4  my-4 rounded-lg hover:scale-105 duration-300 hover:bg-gray-100 pt-20 mb-20 ">
          <img
            ...
            alt="/"
          />
          <h2 className="text-2xl font-bold text-center py-8">Package Plan</h2>
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300 hover:bg-gray-100 pt-20 mb-20">
          ...
          <div className="text-center font-medium">
            ...
            <p className="py-2 border-b mx-8">Network topology map services</p>
          </div>
          <div className="flex-grow"></div>
          <Link
            to="/contact"
